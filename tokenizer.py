...
class TAPETokenizer():
    ...
    def __init__(self, vocab: str = 'iupac'):
        ...
        elif vocab == 'glycolysation':
            self.vocab = GLYC_VOCAB
...
#Give AA sequence or glycosylation site sequences. 
#Returns sequence of key values derived from one of the dictionaries, GLYC_VOCAB or IUPAC_VOCAB.